...
class User implements UserInterface
{
    ...
    // implémentiation de la userInterface

    public function getRoles(){
        // userRoles est une arrayCollection, map va boucler sur tous éléments et rendre une arrayCollection avec la modif -> toArray transforme en tableau
        
        $roles = $this->userRoles->map(function($role){
            return $role->getTitle();
        })->toArray();

        $roles[] = "ROLE_USER"; // ajouter le role user en plus 
    ...
    public function removeBooking(Booking $booking): self
    {
        ...
        return $this;
    } // permet de supprimer des données sensible de l'utilisateur
