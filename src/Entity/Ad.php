...
class Ad
{
     ...
     *
     * @return array Un tableau d'objets DateTime représentent les jours d'occupation
     */
    public function getNotAvailableDays(){
        $notAvailableDays = [];
        foreach($this->bookings as $booking){
            // calculer les jours qui se trouvent entre la daye d'arrivée et de départ
            // la fonction range de php permet de créer un tableau qui contient chaque étape existante entre deux nombres
            // resltat= range(10,20,2);
            // réponse : $resultat : [12,12,14,16,18,20];
